...
<head>
    ...
    <script>
    	function select_company(company){
    		window.location="<?php echo U('Order/agent_order');?>"+"?company="+company;
    	}
    </script>
</head>
<body>
    ...
    <div class="w-1204">
        <div class="navtop clear">
            ...
            <div class="adminbox fl">
                ...
                <a><a href="<?php echo U('Login/logout');?>">退出</a></a>
            </div>
        </div>
        <div class="nav clear">
            <a href="<?php echo U('Order/user_order');?>" class="fl">普通用户订单</a>
            <a href="<?php echo U('Order/agent_order');?>" class="active fl">代理商订单</a>
...
<!--弹窗-->
    ...
    <form action="<?php echo U('Order/agent_output');?>" method='get'>
    ...
    <div class="sortbox">
    <form action="<?php echo U('Order/agent_order');?>" method='get'>
    ...
    <table class="order-table">
        ...
        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr >
            ...
            <td><?php echo ($v["export"]); ?></td><td><a  onclick="select_company('<?php echo ($v["company"]); ?>')"><?php echo ($v["company"]); ?></a></td>
            <td><?php echo ($v["recharge"]); ?>元</td>
